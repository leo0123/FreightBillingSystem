...
(function (Freight) {
    ...
    Freight.ProfitCenterAmountEditField = function (ctx) {
        ...
        function renderField(value, profitCenters) {
            var reactField = React.createElement(ProfitCenterAmountField, {
                "profitCenters": profitCenters, "value": value, "onChange": function (value, totalAmount) {
                    fieldValue = value;
...
function FreightInvoiceFormEnhance() {
    ...
    window.PreSaveAction = function () {
        ...
        if (window.myPreSaveAction) {
            if (window.myPreSaveAction() == false) {
                return false;
            }
        }
        return true;
